...
For detailed instructions on how to deploy this application to a production environment using Docker, please refer to the main `DEPLOY.md` file in the root of the project.

[**See Deployment Guide**](../statdent-infra/DEPLOY.md)
